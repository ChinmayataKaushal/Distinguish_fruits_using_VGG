Kaggle's Fruits360 is a project in which the model classifies an image of a fruit into one of the 120 classes. In this we used pretrained VGG model for better results.
